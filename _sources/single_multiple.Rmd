...
We have seen simple regression methods in the [finding lines](finding_lines)
page, and those following.
...
Here we go back a little, to simple regression, and show how it relates
...
Here we build the machinery for multiple regression.
